...
using WebApi.CachePerRequest.Middlewares;
using WebApi.CachePerRequest.Options;
using WebApi.CachePerRequest.Repositories;
using WebApi.CachePerRequest.Validators;

namespace WebApi.CachePerRequest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebApi.CachePerRequest", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebApi.CachePerRequest v1"));
            }

            app.UseHttpsRedirection();

            app.UseMiddleware<TraceCacheMiddleware>();
